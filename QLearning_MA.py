...
# dict che tiene conto della frequenza di scelta delle action per ogni episodio
action_dict = {'EPISODE_'+str(i): {'ACTION_'+str(a): 0 for a in range(3)} for i in range(1, 6)}
# dict che tiene conto della reward accumulata di ogni agent per ogni episodio
reward_per_episode = {'EPISODE_'+str(i): {'AGENT_'+str(a): 0 for a in range(params['learner_population'])} for i in range(1, 6)}
...
for ep in range(1, 6):
    ...
    for tick in range(400):
        ...
        for agent in env.agent_iter(max_iter=params['learner_population']):
            ...
            action_dict['EPISODE_'+str(ep)]['ACTION_'+str(action)] += 1
            env.step(action)
            ...
            reward_per_episode['EPISODE_'+str(ep)]['AGENT_'+str(agent)] += reward
